...
export async function identifyPlantWithGemini2(
  imageBase64: string,
  language: string = "et",
  chatQuery: string = "",
): Promise<PlantInfo> {
  try {
    ...
    if (chatQuery) {
      console.log("Sending chat query to Gemini 2.0...");
    ...
    console.error("Error identifying plant with Gemini 2.0:", error);
    throw error;
  }
}
